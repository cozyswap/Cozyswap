...
contract CozyStakingComplete {
    ...
    uint32 public rewardHalvingPeriod;// ✅ FIXED: Changed to uint32 for 100000
    ...
    constructor(
        ...
        rewardHalvingPeriod = 100000; // ✅ FIXED: Now compatible with uint32
    }
    ...
    function _safeCozyTransfer(address _to, uint256 _amount) internal {
        // ✅ FIXED: Use library function instead of direct interface call
    ...
    // Additional essential view functions
...
// Optimized SafeERC20 library with explicit interface
library SafeERC20 {
...
// Explicit interface with selector to avoid conflicts
interface IERC20 {
